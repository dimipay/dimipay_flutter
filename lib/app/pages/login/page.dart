...
class TopArea extends StatelessWidget {
  GyroScopeController gyroScopeController = Get.find<GyroScopeController>();
  TopArea({super.key});
      ...
      child: Obx(
        () => Transform(
          transform: Matrix4.identity()
            ..setEntry(3, 2, 0.001)
            ..rotateX(gyroScopeController.vector.value.y)
            ..rotateY(gyroScopeController.vector.value.x),
          alignment: FractionalOffset.center,
          child: DPCard(cardName: '디미페이', cardNumber: '1234', color: DPColors.MAIN_THEME),
        ),
      ),
    );
    ;
