                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text("Face Sign을 이용한 빠른 결제", style: DPTextTheme.PAGE_HEADER),
                      ...
                      const SizedBox(height: 12),
                      const Text.rich(TextSpan(style: DPTextTheme.PAGE_DESCRIPTION, children: [
                        TextSpan(text: "네이버 클라우드와 CLOVA가 개발한 인공지능 기술로 안전하게 인증할 수 있습니다.\n"),
                        TextSpan(text: "\n서버에는 사용자의 이미지가 아닌 얼굴의 특징만 저장돼서, 걱정 없이 사용할 수 있어요."),
                      ])),
                      //description 생략
                      //"네이버 클라우드와 CLOVA가 개발한 인공지능 기술로 안전하게 인증할 수 있습니다"
                      //네이버 클라우드와 CLOVA가 개발한 인공지능 기술로 안전하게 인증할 수 있습니다. 서버에는 사용자의 이미지가 아닌 얼굴의 특징만 저장돼서, 걱정 없이 사용할 수 있어요.
                    ],
                  ),
                ),
              ),
