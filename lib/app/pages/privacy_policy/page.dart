...
class PrivacyPolicyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String privacyPolicyText = '''
      ...
      개인정보의 수집·이용
          (1) 회원 정보의 수집·이용목적, 수집항목, 보유·이용기간은 아래와 같습니다. 수집•이용목적	수집 항목	보유•이용기간 회원가입, 서비스 이용 및 상담	아이디(E-mail 주소), 비밀번호, 성명, 핸드폰 번호	목적달성(회원탈퇴 등) 후 지체 없이 파기 (단 관련법령 및 회사정책에 따라 별도 보관되는 정보는 예외) 아이디인 이메일은 부정이용 이슈 방지를 위해 탈퇴DB에서 3개월후 삭제 성인인증(14세 미만)	생년월일 마케팅 활용	성별, 생년월일, 주소 서비스 이용 및 부정거래기록 확인	서비스이용기록, 접속로그	회원 탈퇴 시 즉시 삭제 본인 확인	핸드폰 번호	회원 탈퇴 시 즉시 삭제 주문 및 결제 서비스	상품결제정보(구매/취소반품교환/환불),카드결제정보	목적달성(사용완료 등) 후 지체 없이 파기 단, 구매관련 정보의 경우 5년간 보관 (전자상거래 등에서의 소비자보호에 관한 법률)
      개인정보의 제 3자 제공
      회사는 이용자의 개인정보를 개인정보 수집·이용 목적에서 명시한 범위 내에서 사용하며, 이용자의 사전 동의 없이 개인정보 수집·이용 목적 범위를 초과하여 이용하거나 원칙적으로 이용자의 개인정보를 제공하지 않습니다. 다만, 아래와 같이 양질의 서비스 제공을 위해 이용자의 개인정보를 협력업체와 공유할 필요가 있는 경우에는 제공 받는 자, 제공목적, 제공정보 항목, 이용 및 보유기간 등을 회원에게 고지하여 동의 구하거나 관련법령에 따른 경우는 예외로 합니다. 이용자가 사전에 공개 또는 제3자 제공에 동의한 경우 제공받는 자	제공 목적	제공 정보	개인정보를 제공 받는 자의 개인 정보보유 및 이용기간 결제상품 제공업체 (입점업체)	서비스제공, 구매자 확인	주문 정보, ID, 결제수단 및 서비스의 정보	재화 또는 서비스의 제공이 완료된 즉시 파기(단, 관계법령에 정해진 규정에 따라 법정기간 동안 보관) (주) KG 이니시스	결제서비스 처리	상품명, 상품결제금액, 결제 인증값	목적달성 후 즉시파기(단, 관련법령에 따라 별도 보관되는 정보는 예외)
      개인정보의 파기절차 및 방법
      ...
      회사는 개인정보가 파기되거나 분리되어 저장•관리된다는 사실, 서비스 미이용 기간 만료일, 해당 개인정보의 항목을 공지사항, 전자우편 등의 방법으로 미이용 기간 30일 전에 회원에게 알립니다. 이를 위해 회원은 회사에게 정확한 연락처 정보를 알리거나 수정하여야 합니다.
          (2) 개인정보 파기의 절차 및 방법은 다음과 같습니다. ① 파기절차 회사는 파기 사유가 발생한 개인정보를 개인정보 보호책임자의 승인 절차를 거쳐 파기합니다. ② 파기방법 회사는 전자적 파일형태로 기록·저장된 개인정보는 기록을 재생할 수 없도록 기술적인 방법 또는 물리적인 방법을 이용하여 파기하며, 종이에 출력된 개인정보는 분쇄기로 분쇄하거나 소각 등을 통하여 파기합니다.
    ''';
