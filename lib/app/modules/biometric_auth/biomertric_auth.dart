      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text.rich(TextSpan(style: DPTextTheme.PAGE_HEADER, children: [
                TextSpan(text: "얼굴인증을 이용하면\n"),
                TextSpan(text: "더 빠르게 결제할 수 있어요"),
              ])),
              Text.rich(TextSpan(style: DPTextTheme.PAGE_DESCRIPTION, children: [TextSpan(text: "얼굴인증은 매점의 결제단말기에서 사용자의 얼굴을인식해서 결제하는 본인인증 수단이에요.\n"), TextSpan(text: "본인의 사진을 한번만 등록해두면, 휴대폰 없이도 빠르게결제할 수 있어요.\n"), TextSpan(text: "서버에는 사용자의 이미지가 아닌 얼굴의 특징만 저장돼서, 안전하게 사용할 수 있어요.")])),
